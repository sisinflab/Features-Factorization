...
public class MainCoord {
    ...
    public static void main(String[] args) throws IOException {
        ...
        HashMap<Integer, ArrayList<Integer>> map = ItemsAttributesManager.loadMap(filePath,fileAttrPath,featuresNames,threshold,propertiesPath,false);
        HashMap<Integer, HashMap<Integer, Float>> ratingsMap = ItemsAttributesManager.loadRatings(filePath,map);


        HashMap<Integer, ArrayList<AbstractMap.SimpleEntry<Integer, Float>>> recs = App.useContent(ratingsMap,map,nRecc);
